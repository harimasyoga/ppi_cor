<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 col-input-hpp" style="display:none">
					<div class="card card-success card-outline" style="padding-bottom:12px">
						...
						<div class="card-body row cbr-bahan-pembantu">
						...
						<div class="card-body row cbr-solar">
						...
						<div class="card-body row cbr-ekspedisi">
						...
						<div class="card-body row cbr-lain-lain">
...
<script type="text/javascript">
	...
	function hideAll(opsi)
	{
		...
		$(".cbr-depresiasi").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
		$(".cbr-bahan-pembantu").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
		$(".cbr-solar").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
		$(".cbr-ekspedisi").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
		$(".cbr-lain-lain").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
		$(".cbr-opsional").attr('style', (opsi == 'show') ? 'font-weight:bold;padding:0 12px 6px' : 'display:none')
	}
	...
	function pilihHPP()
	{
		...
		if(pilih_hpp == "PM"){
			...
			$(".cbr-bahan-pembantu").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".cbr-lain-lain").attr('style', 'font-weight:bold;padding:0 12px 6px')
			...
			$(".cbr-tenaga-kerja").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".cbr-bahan-pembantu").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".cbr-ekspedisi").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".cbr-lain-lain").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".cbr-opsional").attr('style', 'font-weight:bold;padding:0 12px 6px')
			$(".simpan-lam-cor").html(simpanLC)
		}else{
